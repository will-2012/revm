...
## [7.0.5](https://github.com/bluealloy/revm/compare/revme-v7.0.4...revme-v7.0.5) - 2025-07-17

### Other

- updated the following local packages: revm-primitives, revm-database-interface, revm-inspector, revm, revm-bytecode, revm-state, revm-context-interface, revm-context, revm-database, revm-statetest-types
